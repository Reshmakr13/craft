<div class="flex flex-col md:flex-row border border-blue/50 rounded-xl md:gap-x-3 lg:gap-x-1 ">
    ...
    <div class="mt-6 md:w-2/3 flex  flex-col  justify-end items-center  lg:items-start gap-y-3 font-franklin text-sm lg:text-base my-auto mx-auto">
        <div class="w-11/12 flex justify-end">
            <a href="#"class="mb-8 flex flex-row justify-center py-2 lg:py-2 px-3  bg-blue font-franklin rounded-3xl shadow-[0px_10px_3px_-6px_rgba(0,0,0,0.3)] items-center space-x-1 w-fit  ">
