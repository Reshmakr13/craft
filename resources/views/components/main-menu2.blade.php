        ...
        <div class="  flex flex-col  top-0  ">
            ...
            <div
                ...
                <div
                    ...
                    <a href="{{route('training_courses')}}" @click.prevent.stop="$dispatch('linkaction', {link: '{{route('training_courses')}}', route: 'training_courses'})">
                    ...
                    <a href="{{route('contact')}}" @click.prevent.stop="$dispatch('linkaction', {link: '{{route('contact')}}', route: 'contact'})">{{ __('main_menu.contact') }}</a>
                    <a href="{{route('ebook')}}" @click.prevent.stop="$dispatch('linkaction', {link: '{{route('ebook')}}', route: 'ebook'})">
                        <div class="flex flex-row rtl:flex-row-reverse items-center">
                            <div>
            ...
            <div x-data="{ open: false }" class="flex ltr:justify-end rtl:justify-end items-center py-6">
                ...
                <div x-show="open" class=" fixed  bg-white bg-opacity-90 w-full   h-scren overflow-y-scroll inset-0 z-30  ">
                    ...
                    <ul class="relative ltr:space-y-2 rtl:space-y-2 rtl:space-y-reverse mt-28 ltr:pl-6 rtl:pr-6 mx-10 sm:mx-16">
                        ...
                        <li class=" text-black  hover:text-pink"><a href="{{route('training_courses')}}" @click.prevent.stop="$dispatch('linkaction', {link: '{{route('training_courses')}}', route: 'training_courses'})"
                                class="font-questrial  py-1 md:py-2">{{ __('main_menu.training') }}</a></li>
                        ...
                        <li class=" text-black  hover:text-pink"><a href="{{route('ebook')}}" @click.prevent.stop="$dispatch('linkaction', {link: '{{route('ebook')}}', route: 'ebook'})"
                                class="font-questrial  py-1 md:py-2">{{ __('main_menu.ebook') }}</a></li>
