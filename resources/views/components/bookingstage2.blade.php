        ...
        @csrf
                ...
                <div  class="mt-6">
                    <ul  class="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-10 gap-y-6 lg:gap-x-4 xl:justify-between">
                        ...
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Mar'" :date="'30'" :day="'Saturday'"/></li>
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Mar'" :date="'31'" :day="'Sunday'"/></li>
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Apr'" :date="'1'" :day="'Monday'"/></li>
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Apr'" :date="'2'" :day="'Tuesday'"/></li>
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Apr'" :date="'2'" :day="'Wednesday'"/></li>
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Apr'" :date="'4'" :day="'Thursday'"/></li>
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Apr'" :date="'5'" :day="'Friday'"/></li>
                        <li @click.prevent="selected = true"  ><x-booking-date-component :month="'Apr'" :date="'6'" :day="'Saturday'"/></li>
                    </ul>
