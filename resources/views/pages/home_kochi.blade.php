...
<div class="bg-white">
    ...
    <x-expert  src="{{url('/images/home/noushinashraf.png')}}" :name="'Dr. Noushin Ashraf'" :qualification="'MD, FRM, MRCOG (UK), MRCP (IE) '" :designation="'Sr. Consultant in Reproductive Medicine'"
